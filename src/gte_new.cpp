...
static  unsigned long MFC2(long reg) {
	switch(reg) {
		case 29:
...
static  void MTC2(unsigned long value, long reg) {
	long a;
...
static  long float2int(double d)
{
	double dtemp = MAGIC + d;
	return (*(long *)&dtemp)-0x80000000;
}*/
/*
static  double EDETEC1(double data)
{
...
static  double EDETEC2(double data)
{
...
static  double EDETEC3(double data)
{
...
static  double EDETEC4(double data)
{
...
static  double NC_OVERFLOW1(double x) {
...
static  double NC_OVERFLOW2(double x) {
...
static  double NC_OVERFLOW3(double x) {
...
static  double NC_OVERFLOW4(double x) {
...
static  s32 FNC_OVERFLOW1(s64 x) {
...
static  s32 FNC_OVERFLOW2(s64 x) {
...
static  s32 FNC_OVERFLOW3(s64 x) {
...
static  s32 FNC_OVERFLOW4(s64 x) {
...
static  double limA1S(double x) { _LIMX(-32768.0, 32767.0, 24); }
static  double limA2S(double x) { _LIMX(-32768.0, 32767.0, 23); }
static  double limA3S(double x) { _LIMX(-32768.0, 32767.0, 22); }
static  double limA1U(double x) { _LIMX(0.0, 32767.0, 24); }
static  double limA2U(double x) { _LIMX(0.0, 32767.0, 23); }
static  double limA3U(double x) { _LIMX(0.0, 32767.0, 22); }
static  double limB1 (double x) { _LIMX(0.0, 255.0, 21); }
static  double limB2 (double x) { _LIMX(0.0, 255.0, 20); }
static  double limB3 (double x) { _LIMX(0.0, 255.0, 19); }
static  double limC  (double x) { _LIMX(0.0, 65535.0, 18); }
static  double limD1 (double x) { _LIMX(-1024.0, 1023.0, 14); }
static  double limD2 (double x) { _LIMX(-1024.0, 1023.0, 13); }
static  double limE  (double x) { _LIMX(0.0, 4095.0, 12); }

static  double limG1(double x) {
...
static  s32 F12limA1S(s64 x) { _LIMX(-32768<<12, 32767<<12, 24); }
static  s32 F12limA2S(s64 x) { _LIMX(-32768<<12, 32767<<12, 23); }
static  s32 F12limA3S(s64 x) { _LIMX(-32768<<12, 32767<<12, 22); }
static  s32 F12limA1U(s64 x) { _LIMX(0, 32767<<12, 24); }
static  s32 F12limA2U(s64 x) { _LIMX(0, 32767<<12, 23); }
static  s32 F12limA3U(s64 x) { _LIMX(0, 32767<<12, 22); }

static  s16 FlimA1S(s32 x) { _LIMX(-32768, 32767, 24); }
static  s16 FlimA2S(s32 x) { _LIMX(-32768, 32767, 23); }
static  s16 FlimA3S(s32 x) { _LIMX(-32768, 32767, 22); }
static  s16 FlimA1U(s32 x) { _LIMX(0, 32767, 24); }
static  s16 FlimA2U(s32 x) { _LIMX(0, 32767, 23); }
static  s16 FlimA3U(s32 x) { _LIMX(0, 32767, 22); }
static  u8  FlimB1 (s32 x) { _LIMX(0, 255, 21); }
static  u8  FlimB2 (s32 x) { _LIMX(0, 255, 20); }
static  u8  FlimB3 (s32 x) { _LIMX(0, 255, 19); }
static  u16 FlimC  (s32 x) { _LIMX(0, 65535, 18); }
static  s32 FlimD1 (s32 x) { _LIMX(-1024, 1023, 14); }
static  s32 FlimD2 (s32 x) { _LIMX(-1024, 1023, 13); }
static  s32 FlimE  (s32 x) { _LIMX(0, 65535, 12); }
//static  s32 FlimE  (s32 x) { _LIMX(0, 4095, 12); }

static  s32 FlimG1(s64 x) {
...
*/
/*
__force double ncLIM1(double x)
{
