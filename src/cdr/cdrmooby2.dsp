...
# ADD CPP /nologo /G6 /MT /W3 /GX /O2 /I "$(fltkdir)" /I "./bzip" /I "./zlib" /I "$(portaudiodir)/include" /I "./unrar" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "CDRMOOBY2_EXPORTS" /D "SILENT" /D "UNRAR" /FD /c
# SUBTRACT CPP /X
...
# ADD CPP /nologo /G5 /MTd /W3 /Gm /GX /ZI /Od /I "$(fltkdir)" /I "./bzip" /I "./zlib" /I "$(portaudiodir)/include" /I "./unrar" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "CDRMOOBY2_EXPORTS" /FD /GZ /c
...
# ADD LINK32 fltkd.lib PAStaticDSD.lib dsound.lib winmm.lib wsock32.lib comctl32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /pdb:none /debug /machine:I386 /libpath:"$(fltkdir)\lib" /libpath:"$(fltkdir)/lib" /libpath:"$(portaudiodir)/lib"
