...
#define PSX4ALL_LGW  "LOAD A GAME WITHOUT BIOS"
...
s32 SelectGame()
{
	...
	for(;;)
	{
		...
		case PSX4ALL_MENU_DEFAULT_STATE:
			...
			gp2x_printf(NULL, 100, PSX4ALL_MENU_START_POS + 20,	PSX4ALL_FO);
			if (psx4all_emulating) gp2x_printf(NULL, 100, PSX4ALL_MENU_START_POS + 30, PSX4ALL_RES);
			else gp2x_printf(NULL, 100, PSX4ALL_MENU_START_POS + 30,	PSX4ALL_QT);
			break;
		case PSX4ALL_MENU_GPU_STATE:
