...
#define gp2x_screen16	((unsigned short *)BaseAddress)

extern "C" void app_SetSvsFile(char* filename);
extern "C" int __emulation_run;
extern "C" void updateScreen(); 
extern "C" int global_enable_audio;

extern unsigned short* videobuffer;

extern void gp2x_sound_play(void *buff, int len);
extern "C" unsigned long gp2x_joystick_read(void);
...
#define gp2x_video_flip()	updateScreen();
